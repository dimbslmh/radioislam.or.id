...
import {
  ...
  GetStationsExcluding
} from "@service/react-query/queries/stations";

export function OtherStations({ provinces }: { provinces: string[] }) {
  const [opened, setOpened] = useState(false);
  const { data } = GetStationsExcluding(provinces);
